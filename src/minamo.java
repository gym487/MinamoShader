...
public  class minamo extends Thread {
	...
	public  static void main(String arg[]){//Test scene below
		...
		scene[2]=new diffSurface(new vec(4,-4,16),new vec(4,4,16),new vec(4,-4,1),new spec(0.1,0.1,0.5),1);
		...
		scene[6]=new refsphere(new vec(2,2.5,13),1.5,new spec(0.05,0.05,0.05),new spec(0.9,0.9,0.9),1.5);
		scene[7]=new mirrsphere(new vec(-2,2.5,12),1.5,new spec(0.9,0.9,0.9));
		//scene[6]=new refSurface(new vec(-4,-4,13),new vec(-4,4,13),new vec(4,-4,13),new spec(0.05,0.05,0.05),new spec(0.9,0.9,0.9),1,1.5);
