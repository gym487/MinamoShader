...
public  class minamo extends Thread {
	...
	public  static void main(String arg[]){//Test scene below
		...
		scene[1]=new gridDiffSurface(new vec(6,4,18),new vec(-6,4,18),new vec(6,4,-4),new spec(0.1,0.5,0.1),new spec(0.5,0.5,0.5),1,7,14);
		...
		//scene[6]=new water(new vec(-6,2,-4),12,22,24,48);
