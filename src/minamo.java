...
public  class minamo extends Thread {
	...
	public  static void main(String arg[]){//Test scene below
		...
		cam c=new focuscam(new vec(0,0,0),new vec(0,0,1),new vec(0,1,0),500,500,0.1,0.1,18.0);
		scene=new surface[2];
		threadn=4;
		thok=new int[c.x];
		Arrays.fill(thok,-1);
		...
		scene[0]=new gridDiffSurface(new vec(60,4,180),new vec(-60,4,180),new vec(60,4,-4),new spec(0.1,0.5,0.1),new spec(0.5,0.1,0.5),1,30,60);
		...
		scene[1]=new lightSurface(new vec(-30,-3.99,120),new vec(30,-3.99,120),new vec(-30,-3.99,8),new spec(30000,30000,30000),1);
